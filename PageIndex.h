...
<html>
	<head>
	  ...
	  <meta name="viewport" content="width=device-width, initial-scale=1">
		<style>
		  ...
		  p {font-size: 1.2rem;}
		  body {margin: 0;}
		  .topnav {overflow: hidden; background-color: #3d85c6; color: white; font-size: 1.5rem;}
		  .content {padding: 20px; }
		  .card {background-color: white; box-shadow: 0px 0px 10px 1px rgba(140,140,140,.5); border: 1px solid #3d85c6; border-radius: 7px;}
		  .card.header {background-color: #3d85c6; color: white; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; border-top-right-radius: 7px; border-top-left-radius: 7px;}
	...
	<body>
		<div class="topnav">
		<h3>ESP32 ESP-NOW & WEB SERVER (CONTROLLER)</h3>
		</div>
		<br>
